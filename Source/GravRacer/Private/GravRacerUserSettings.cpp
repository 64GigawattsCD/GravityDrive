...
UGravRacerUserSettings::UGravRacerUserSettings(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	SetToDefaults();
}

void UGravRacerUserSettings::SetToDefaults()
{
	Super::SetToDefaults();
...
void UGravRacerUserSettings::ApplySettings(bool bCheckForCommandLineOverrides)
{
...
bool UGravRacerUserSettings::IsMouseSensitivityDirty() const
{
	bool bIsDirty = false;
...
bool UGravRacerUserSettings::IsInvertedMouseDirty() const
{
	bool bIsDirty = false;
	if (GEngine)
	{
...
bool UGravRacerUserSettings::IsDirty() const
{
	return Super::IsDirty() || IsMouseSensitivityDirty() || IsInvertedMouseDirty();
}

void UGravRacerUserSettings::ResetToCurrentSettings()
{
...
void UGravRacerUserSettings::SetLowQuality()
{
...
void UGravRacerUserSettings::SetHighQuality()
{
	IConsoleVariable* CVarClearMethod = IConsoleManager::Get().FindConsoleVariable(TEXT("r.ClearSceneMethod"));
