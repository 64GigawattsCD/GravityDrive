...
class SGravRacerControlsSetup : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SGravRacerControlsSetup)
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<AGravRacerHUD>, OwnerHUD)
...
protected:
	...
	*/
	...
	TWeakObjectPtr<class AGravRacerHUD> OwnerHUD;

	/** Pointer to our parent widget */
	TSharedPtr<class SWidget> OwnerWidget;

	/** Style for this menu item */
	const struct FGravRacerMenuItemStyle *MenuItemStyle;
