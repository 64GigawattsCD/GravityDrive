...
USkeletalMeshComponent* AGSWeapon::GetWeaponMesh() const
{
	return WeaponMesh;
}
...
void AGSWeapon::SetOwningCharacter(AGravRacerPawn* InOwningCharacter)
{
...
void AGSWeapon::NotifyActorBeginOverlap(AActor* Other)
{
	...
	{
		PickUpOnTouch(Cast<AGravRacerPawn>(Other));
	}
}
...
void AGSWeapon::PickUpOnTouch(AGravRacerPawn* InCharacter)
{
