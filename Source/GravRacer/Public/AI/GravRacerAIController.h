...
#include "GravRacerAIController.generated.h"

class UBehaviorTreeComponent;
class UBlackboardComponent;

UCLASS(config=Game)
class AGravRacerAIController : public AAIController
{
...
public:
	...
	class AGravRacerPawn* GetEnemy() const;
	...
	UFUNCTION(BlueprintCallable, Category = Behavior)
	bool FindClosestEnemyWithLOS(AGravRacerPawn* ExcludeEnemy);
...
protected:
	...
	bool LOSTrace(AGravRacerPawn* InEnemyChar) const;
