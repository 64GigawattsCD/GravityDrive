...
class GRAVRACER_API UGSTargetType : public UObject
{
	GENERATED_BODY()
...
class GRAVRACER_API UGSTargetType_UseOwner : public UGSTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class GRAVRACER_API UGSTargetType_UseEventData : public UGSTargetType
{
	GENERATED_BODY()
