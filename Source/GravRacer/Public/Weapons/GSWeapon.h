...
class GRAVRACER_API AGSWeapon : public AActor, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
public:	
	...
	void SetOwningCharacter(AGravRacerPawn* InOwningCharacter);
...
protected:
	...
	AGravRacerPawn* OwningCharacter;
	...
	virtual void PickUpOnTouch(AGravRacerPawn* InCharacter);
