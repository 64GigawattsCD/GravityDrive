...
struct FGravRacerLoadingScreenBrush : public FSlateDynamicImageBrush, public FGCObject
{
	FGravRacerLoadingScreenBrush( const FName InTextureName, const FVector2D& InImageSize )
...
public:
	...
	void Construct(const FArguments& InArgs)
	{
		...
		LoadingScreenBrush = MakeShareable( new FGravRacerLoadingScreenBrush( LoadingScreenName, FVector2D(1920,1080) ) );
...
class FGravRacerLoadingScreenModule : public IGravRacerLoadingScreenModule
{
public:
...
IMPLEMENT_GAME_MODULE(FGravRacerLoadingScreenModule, GravRacerLoadingScreen);
